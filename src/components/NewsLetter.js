  ...
  return (
    <div className='max-w-[1520px] m-auto text-white px-4 bg-[#24262b]'>
     <div className='mx-auto grid lg:grid-cols-3'>
        ...
        <div className='my-4'>
            <div className='flex flex-cols sm:flex-row items-center justify-between w-full'>
                <input type='email' placeholder='email' className='p-3 flex w-full rounded-md text-black'/>
                <button className='bg-[#00df9a] text-white rounded-md font-medium w-[200p] ml-4 my-6 py-0 px-6 border-none'>
                    Notify Me
                </button>
            </div>
            <p>we are concerned about your data privacy, Read{" "}
