...
import {FaUserFriends, FaGoogleWaller, FaGoogleWallet} from 'react-icons/fa'
import {MdHelp,MdOutlineFavorite} from 'react-icons/md'
const TopNav = () => {
    const [sideNav, setSideNav] = useState(false);
    console.log(sideNav)
  return (
        <div className="max-w-[1520] mx-auto flex justify-content items-center p-4">
          <div className='flex items-center'>
            ...
            <div className='hidden lg:flex items-center bg-gray-200 mr-20 rounded-full p-1 text-[14px]'>
          ...
          <div className='bg-gray-200 rounded-full flex items-center mr-20 px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
